...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	$(".btn-like").click(function(e) {
		...
		$(".more-text").click(function(e) {
			e.preventDefault();
				$(this).toggleClass("active");
				$(this).siblings(".text-about").toggleClass("active");
			});

			{
				if ($(window).width() < 992) { 
					...
					$(".item-dropdown__head").click(function() {
						$(this).parents().siblings().find(".item-dropdown__head").removeClass("active");
						$(this).parents().siblings().find(".item-dropdown__content").slideUp(200);
						$(this).toggleClass("active");
	...
	$(".btn-filter_filter").click(function(e) {
		e.preventDefault();
		$(".sorting-catalog").slideUp(200);
		$(".btn-filter_sorting").removeClass("active");
	...
	$(".btn-filter_sorting").click(function(e) {
		e.preventDefault();
		$(".sidebar-catalog").slideUp(200);
		$(".btn-filter_filter").removeClass("active");
		$(".sorting-catalog").slideToggle(200);
		$(this).toggleClass("active");
	});
	...
	$('.tabs-main li a').click(function(event) {
		...
		$(this).parent().parent().parent().find(".tab-pane-main").fadeOut(0);
	...
	{
		if ($(window).width() < 992) { 
			$(".card-info__head").click(function() {
				$(this).parents().siblings().find(".card-info__head").removeClass("active");
				$(this).parents().siblings().find(".card-info__content").slideUp(200);
				$(this).toggleClass("active");
				$(this).next(".card-info__content").slideToggle(200);
			}); 

			$(".title-min_dropdown").click(function() {
				$(this).parents().siblings().find(".title-min_dropdown").removeClass("active");
				$(this).parents().siblings().find(".content-dropdown").slideUp(200);
				$(this).toggleClass("active");
				$(this).next(".content-dropdown").slideToggle(200);
			}); 
	}
}
